...
import static leoli.middleware.app.config.TopicConfig.EXCHANGE_MIDDLEWARE_TOPIC;
import static leoli.middleware.app.config.TopicConfig.QUEUE_SENDER_0001;
