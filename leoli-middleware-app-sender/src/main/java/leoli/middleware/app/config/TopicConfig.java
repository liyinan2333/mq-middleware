...
import leoli.middleware.app.Application;
...
public class TopicConfig {
     ...
     * 交换器
     */
    public final static String EXCHANGE_MIDDLEWARE_TOPIC = "leoli.middleware";
    /**
     * topic
     */
    public final static String QUEUE_SENDER_0001 = "sender.0001.queue";
    public final static String QUEUE_SENDER_0002 = "sender.0002.queue";
    public final static String QUEUE_SENDER_ALL = "sender.all.queue";
